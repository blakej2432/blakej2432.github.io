---
title: "[LLM] 로컬 LLM 구동하기 with OLLaMA"
date: 2024-12-11 18:24:28 +0900
categories: llm
tags: llm ollama
header:
...
- 계정당 한개 도메인 할당 제공
- [localhost:8000](<http://localhost:8000>) → <https://perfect-nationally.ngrok-free.app/llm/playground/>
- 챗봇 형태의 랩큐라마 사용 가능
